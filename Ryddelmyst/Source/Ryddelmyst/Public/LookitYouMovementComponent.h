...
/**
 * A PawnMovementComponent directing a LookitYouPawn to fly about within a radius around its associated FollowPawn
 */
UCLASS()
...
public:
	...
	/**
	 * Moves the LookitYouPawn in an orbit around its FollowPawn, updating location per-frame to be at a Yaw rotated vector that keeps the offset magnitude constant.  
