...
void USlippersOfLongWintersNapItem::OnEquip_Implementation(AActor* EquippedActor)
{
	...
	if (Character)
	{
		Character->GetMetamagicMap()[std::string(TCHAR_TO_UTF8(*ASnowball::StaticClass()->GetName()))][std::string(TCHAR_TO_UTF8(*USlippersOfLongWintersNapItem::StaticClass()->GetName()))][ARyddelmystCharacter::ID_SPELL_PHASE_EVOCATION][ARyddelmystCharacter::ID_METAMAGIC_CATEGORY_ATTR] = [](ASnowball* Snowball)
		{
