...
void USlippersOfLongWintersNapItem::OnEquip_Implementation(AActor* EquippedActor)
{
	...
	if (Character)
	{
		Character->GetMetamagicMap()[ARyddelmystCharacter::ID_SPELL_SNOWBALL][USlippersOfLongWintersNapItem::ID][ARyddelmystCharacter::ID_SPELL_PHASE_EVOCATION][ARyddelmystCharacter::ID_METAMAGIC_CATEGORY_ATTR] = [](ASnowball* Snowball)
		{
